  ...
  return (
    ...
    <section className='mb-[23px] mt-8 xs:my-[72px] max-xs:px-4 ' >
        ...
        <div className='grid grid-cols-2 xs:grid-cols-3 gap-4 xs:gap-6 mt-8 child:bg-white child:rounded-lg xs:child:shadow-4' >
            ...
            <div>
                <img className='w-full max-xs:rounded-lg ' src="../../public/images/Blogs/blog-img1 2.png" alt="" />
            ...
            <div>
                <img className='w-full max-xs:rounded-lg ' src="../../public/images/Blogs/blog-img1 2(1).png" alt="" />
                <div className='xs:pr-7 p-2 mt-2 xs:mt-[19.5px] '>
            ...
            <div>
                <img className='w-full max-xs:rounded-lg ' src="../../public/images/Blogs/blog-img1 2(2).png" alt="" />
                <div className='xs:pr-7 p-2 mt-2 xs:mt-[19.5px] '>
